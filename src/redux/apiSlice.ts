...
export enum TagTypes {
  ...
  QUERY_OVERTIME_FORMATTED = 'QUERY_OVERTIME_FORMATTED ',
  QUERY_CLIENTS_OVERTIME_RAW = 'QUERY_CLIENTS_OVERTIME_RAW',
  QUERY_CLIENTS_OVERTIME_FORMATTED = 'QUERY_CLIENTS_OVERTIME_FORMATTED',
}
